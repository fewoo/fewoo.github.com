...
var IScroll = (function(f, a, e) {
    ...
    var c = (function() {
        ...
        m.momentum = function(v, q, r, o, w) {
            var p = v - q, s = e.abs(p) / r, x, t, u = 0.0006;
            x = v + (s * s) / (2 * u) * (p < 0 ? -1 : 1);
            t = s / u;
            if (x < o) {
                x = w ? o - (w / 2.5 * (s / 8)) : o;
        ...
        m.isAndroidBrowser = /Android/.test(f.navigator.appVersion) && /Version\/\d/.test(f.navigator.appVersion);
        m.extend(m.style = {}, {
            transform: j,
    ...
    g.prototype = {
        ...
        _start: function(k) {
            ...
            if (this.options.preventDefault && !c.isAndroidBrowser && !c.preventDefaultException(k.target, this.options.preventDefaultException)) {
                var j = k.target;
        ...
        _move: function(n) {
            ...
            i = this.x + (this.hasHorizontalScroll ? k : 0);
            q = this.y + (this.hasVerticalScroll ? j : 0);
        ...
        _transitionTime: function(i) {
            i = i || 0;
            this.scrollerStyle[c.style.transitionDuration] = i + "ms";
            if (this.indicator1) {
                this.indicator1.transitionTime(i);
            }
            if (this.indicator2) {
                this.indicator2.transitionTime(i);
            }
        },
        _transitionTimingFunction: function(i) {
            this.scrollerStyle[c.style.transitionTimingFunction] = i;
            if (this.indicator1) {
                this.indicator1.transitionTimingFunction(i);
            }
            if (this.indicator2) {
                this.indicator2.transitionTimingFunction(i);
            }
        },
        _translate: function(i, j) {
            if (this.options.useTransform) {
                this.scrollerStyle[c.style.transform] = "translate(" + i + "px," + j + "px)" + this.translateZ;
            } else {
                i = e.round(i);
                j = e.round(j);
                this.scrollerStyle.left = i + "px";
                this.scrollerStyle.top = j + "px";
            }
            this.x = i;
            this.y = j;
            if (this.indicator1) {
        ...
        _initIndicators: function() {
            var i = this.options.interactiveScrollbars, k = typeof this.options.scrollbars != "object", j = typeof this.options.scrollbars != "string", m, l;
            if (this.options.scrollbars) {
                if (this.options.scrollY) {
                    m = {
                        el: d("v", i, this.options.scrollbars),
                        interactive: i,
                ...
                if (this.options.scrollX) {
                    l = {
                        el: d("h", i, this.options.scrollbars),
                        interactive: i,
                        defaultScrollbars: true,
                        customStyle: j,
                        resize: this.options.resizeIndicator,
                    ...
                    this.wrapper.appendChild(l.el);
                }
            } else {
                m = this.options.indicators.length ? this.options.indicators[0] : this.options.indicators;
                l = this.options.indicators[1] && this.options.indicators[1];
            }
            if (m) {
                this.indicator1 = new b(this,m);
            }
            if (l) {
                this.indicator2 = new b(this,l);
            }
        ...
        _wheel: function(m) {
            ...
            k *= this.options.mouseWheelSpeed;
            j *= this.options.mouseWheelSpeed;
            if (!this.hasVerticalScroll) {
                k = j;
                j = 0;
            }
            ...
            n = this.x + (this.hasHorizontalScroll ? k * this.options.invertWheelDirection : 0);
            l = this.y + (this.hasVerticalScroll ? j * this.options.invertWheelDirection : 0);
            if (n > 0) {
                n = 0;
            } else {
    ...
    function d(l, j, k) {
        ...
        if (k === true) {
            ...
            i.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;border:1px solid rgba(180,180,180,0.9);border-radius:2px;inset;background-image:-webkit-gradient(linear,0% 100%,100% 100%,color-stop(0, #ddd),	color-stop(0.8, #fff));opacity:0.8;";
        }
    ...
    b.prototype = {
        ...
        updatePosition: function() {
            var i = e.round(this.sizeRatioX * this.scroller.x) || 0
              , j = e.round(this.sizeRatioY * this.scroller.y) || 0;
